    ...
    <div class="box">
      ...
      <div id="div-1" class="body collapse in">
        <form action="?page=upreg" method="post">
          ...
          <div class="form-group">
            <label class="control-label col-lg-3">Tanggal Ijazah</label>
            <div class="col-lg-5">
              <div class="input-group">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <input type="text" id="almt_ortu" name="almt_ortu" placeholder="Alamat orang tua" class="form-control" value="<?php echo $r['alamat_orgtua']; ?>" required="required" readonly>
            </div>
          </div>
